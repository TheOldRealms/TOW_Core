...
{
    public class StayInAoEAgentTacticalBehavior : AbstractAgentTacticalBehavior
    {
        public StayInAoEAgentTacticalBehavior(Agent agent, HumanAIComponent aiComponent) : base(agent, aiComponent)
        {
        }
