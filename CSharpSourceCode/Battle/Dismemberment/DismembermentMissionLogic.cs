...
namespace TOW_Core.Battle.Dismemberment
{
    public class DismembermentMissionLogic : MissionLogic
    {
        ...
        private void AddHeadPhysics(GameEntity head, AttackCollisionData collisionData)
        {
            ...
            head.ApplyLocalImpulseToDynamicBody(new Vec3(head.GlobalPosition.X, head.GlobalPosition.Y, head.GlobalPosition.Z + 0.1f), new Vec3(blowDir.X * 5, blowDir.Y * 5, blowDir.Z * 1.1f));
        }
        ...
        private void AddHeaddressPhysics(GameEntity hat, AttackCollisionData collisionData)
        {
            ...
            hat.ApplyLocalImpulseToDynamicBody(new Vec3(hat.GlobalPosition.X, hat.GlobalPosition.Y, hat.GlobalPosition.Z + 1f), new Vec3(blowDir.X * 0.2f, blowDir.Y * 0.2f, blowDir.Z * 0));
        }
