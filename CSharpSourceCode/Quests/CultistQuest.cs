...
namespace TOW_Core.Quests
{
    public class CultistQuest : QuestBase
    {
        ...
        private void SpawnQuestParty(TextObject cultistName)
        {
            ...
            var party = CustomPartyComponent.CreateQuestParty(default, 1f, settlement, cultistName, settlement.OwnerClan, settlement.OwnerClan.DefaultPartyTemplate, settlement.OwnerClan);
